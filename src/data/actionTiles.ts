...
export const STAGE_3_ACTIONS: ActionTile[] = [
  ...
  { id: 'expedition', name: 'Expedition', stage: 3, description: 'Pay either 5 wood or 5 stone to gain up to 4 gold OR Activate up to 3 different orange rooms', iconicDescription: '5[wood] | 5[stone] [arrow-right] +4[gold] \n {or} \n [3]' },
];
